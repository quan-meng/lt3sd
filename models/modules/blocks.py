...
from models.modules.util import (
    checkpoint,
    conv_nd,
    linear,
    avg_pool_nd,
...
class PlainResBlock(TimestepBlock):
    """
...
class ResBlock(TimestepBlock):
    ...
    def __init__(
        ...
        self.emb_layers = nn.Sequential(
            nn.SiLU(),
            conv_nd(
                dims, emb_channels, 2 * self.out_channels if use_scale_shift_norm else self.out_channels, 1
            ),
        )
        self.out_layers = nn.Sequential(
            normalization(self.out_channels),
